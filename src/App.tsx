    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <img src="/brand/villa-hermosa-icon.png" alt="Condominio Villa Hermosa" className="mx-auto h-16 w-16 rounded-2xl shadow-sm" />
          <div className="mx-auto mt-5 h-1 w-20 overflow-hidden rounded-full bg-[#d9ddd9]">
            <div className="h-full w-1/2 animate-pulse rounded-full bg-[#148e98]" />
          </div>
          <p className="mt-4 text-sm text-[#697386]">Preparando tu panel…</p>
        </div>
      </div>
    );
  }
...
function WelcomeScreen() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-[#f2f1ec] to-[#e6f6f3]">
